...
export function FormatArtifactCard({
  ...
  return (
    <div
      className={cn(
        "tonal-layer-1 rounded border border-outline-variant p-section transition-all hover:border-outline hover:shadow-md",
        className,
      )}
    >
      ...
      <h5 className="mb-micro font-bold text-primary">{title}</h5>
      <p className="mb-component font-ui-label-sm text-ui-label-sm text-on-surface-variant">{description}</p>
