...
export function LexiconFileBrowser({
  ...
  return (
    <div className="flex w-72 flex-col border-r border-outline-variant bg-surface-bright">
      <div className="flex items-center justify-between border-b border-outline-variant p-component">
      ...
      <div className="flex-1 space-y-micro overflow-y-auto p-micro custom-scrollbar">
        {nodes.map((node) => (
