...
export function ReaderToolbar({
  ...
  return (
    <div className={cn("fixed bottom-12 left-1/2 z-50 -translate-x-1/2", className)}>
      <div className="flex items-center gap-6 rounded-full border border-outline-variant bg-surface-container-highest/90 px-6 py-3 shadow-xl backdrop-blur-md">
        ...
        <div className="flex items-center gap-4">
          <span
            className={cn(
              "rounded-full px-3 py-1 font-ui-label-md text-ui-label-md",
              activeFamily === "serif"
