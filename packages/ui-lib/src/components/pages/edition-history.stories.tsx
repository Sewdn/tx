      ...
      <main className="min-h-screen pt-shell lg:pl-64">
        <div className="mx-auto max-w-container-max px-boundary py-region">
          <RepositoryHero
            ...
            title="Moby Dick"
            description="The Whale. A definitive archival branch of the 1851 Harper & Brothers edition."
          ...
          <section className="mb-region grid grid-cols-1 gap-region lg:grid-cols-3">
            <ActiveBuildCard
              ...
              description="This build incorporates the latest orthographic corrections from the 1988 Northwestern-Newberry edition while maintaining the original chapter-dash hierarchy of the 1851 print."
          ...
          <LineageTimeline branches={editionLineage} />
...
const meta: Meta = {
  title: "Gittenberg/Pages/Edition History",
